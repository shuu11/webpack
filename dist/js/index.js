...
console.log('app');
var result = (0,_modules_math__WEBPACK_IMPORTED_MODULE_12__.add)(1, 2);
jquery__WEBPACK_IMPORTED_MODULE_10___default()('body').append(result).append("<p>".concat((0,_modules_greet__WEBPACK_IMPORTED_MODULE_13__.greet)('App'), "</p>"));
velocity_animate__WEBPACK_IMPORTED_MODULE_11___default()(jquery__WEBPACK_IMPORTED_MODULE_10___default()('h1'), 'fadeIn', {
  duration: 2000,
  loop: true
}); // console.log(a);
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor","vendor-modules"], function() { return __webpack_require__("./src/js/index.js"); })
